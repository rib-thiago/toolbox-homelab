...
APPLY_TSV="$(ls -t "$RAW_DIR"/stockhausen_batch_apply_1967-79_*.tsv 2>/dev/null | head -1)"

VALIDATION_TSV="$RAW_DIR/stockhausen_batch_post_apply_validation_1967-79_$STAMP.tsv"
REPORT="$REPORT_DIR/stockhausen_batch_post_apply_validation_report_1967-79_$STAMP.txt"
