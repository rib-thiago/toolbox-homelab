...
OUT_TSV="$RAW_DIR/stockhausen_local_normalization_plan_1977-95_MEDIUM_$STAMP.tsv"
REPORT="$REPORT_DIR/stockhausen_local_normalization_plan_1977-95_MEDIUM_$STAMP.txt"
...
target_prefixes = tuple(f"{i:03d}" for i in range(39, 48))
...
with report.open("w", encoding="utf-8") as f:
    ...
    f.write("GROUPING=1977-95: Licht pt. 1\n")
