...
PLAN_TSV="$(ls -t "$RAW_DIR"/stockhausen_local_normalization_plan_1977-95_MEDIUM_*.tsv 2>/dev/null | head -1)"
APPLY_TSV="$(ls -t "$RAW_DIR"/stockhausen_batch_safe_apply_*.tsv 2>/dev/null | head -1)"

VALIDATION_TSV="$RAW_DIR/stockhausen_final_validation_1977-95_MEDIUM_$STAMP.tsv"
REPORT="$REPORT_DIR/stockhausen_final_validation_report_1977-95_MEDIUM_$STAMP.txt"
